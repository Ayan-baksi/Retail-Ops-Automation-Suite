...
// falling back to a default if the sheet or row doesn't exist. Extend
// this pattern for any other value that non-technical users should be
// able to adjust without touching code.
